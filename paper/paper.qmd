...
```{r}
#| label: fig-education-vote
#| fig-cap: The distribution of presidential preferences, by education
#| echo: false
#| warning: false
#| message: false
...
For example, the coefficient for voters with a 4-year education level is -0.251. This indicates that holding all other variables constant, the voters having a 4-year education compared to the reference group(2-year education) is associated with a slight decreases. However, I found that the coefficient -0.251 are not at least twist as large as the standard errors(0.391), which are the number shown in the bracket below the coefficient. This represents that it is not a statistically significant coefficient.
